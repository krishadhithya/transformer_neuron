...
function start_local_service() {
  ...
  if [[ "$(docker images -q $DOCKER_IMAGE_NAME:$DOCKER_IMAGE_TAG 2> /dev/null)" == "" ]]; then
    ...
    docker build -t $DOCKER_IMAGE_NAME:$DOCKER_IMAGE_TAG -f ./transformer/Dockerfile .
  else
    # Build anyway
    docker build -t $DOCKER_IMAGE_NAME:$DOCKER_IMAGE_TAG -f ./transformer/Dockerfile .
  fi
  ...
  function teardown() {
    log "=== stop transformer container ==="
  ...
  # Build start command.
  script="./scripts/transformer.sh"
  COMMAND="$script $identity $serve_address $bind_address $port $eosurl $logdir"
  ...
  --mount type=bind,src="$(pwd)"/data,dst=/bittensor/data \
  --mount type=bind,src="$(pwd)"/transformer,dst=/bittensor/transformer \
...
function main() {
 ...
 log "                                      h:::::h                           b::::::b                                                                    "
 log "                                      h:::::h                           b:::::b                                                                    "
 log "rrrrr   rrrrrrrrr      eeeeeeeeeeee   h::::h hhhhh         ooooooooooo  b:::::bbbbbbbbb      ooooooooooo    aaaaaaaaaaaaa     mmmmmmm    mmmmmmm   "
 log "r::::rrr:::::::::r   ee::::::::::::ee h::::hh:::::hhh    oo:::::::::::oob::::::::::::::bb  oo:::::::::::oo  a::::::::::::a  mm:::::::m  m:::::::mm"
 log "r:::::::::::::::::r e::::::eeeee:::::eh::::::::::::::hh o:::::::::::::::b::::::::::::::::bo:::::::::::::::o aaaaaaaaa:::::am::::::::::mm::::::::::m"
 log "rr::::::rrrrr::::::e::::::e     e:::::h:::::::hhh::::::ho:::::ooooo:::::b:::::bbbbb:::::::o:::::ooooo:::::o          a::::am::::::::::::::::::::::m"
 log "r:::::r     r:::::e:::::::eeeee::::::h::::::h   h::::::o::::o     o::::b:::::b    b::::::o::::o     o::::o   aaaaaaa::::::am:::::mmm::::::mmm:::::m"
 log "r:::::r     rrrrrre:::::::::::::::::eh:::::h     h:::::o::::o     o::::b:::::b     b:::::o::::o     o::::o aa:::::::::::::am::::m   m::::m   m::::m"
 log "r:::::r           e::::::eeeeeeeeeee h:::::h     h:::::o::::o     o::::b:::::b     b:::::o::::o     o::::oa::::aaaa:::::::am::::m   m::::m   m::::m"
 log "r:::::r           e:::::::e          h:::::h     h:::::o::::o     o::::b:::::b     b:::::o::::o     o::::a::::a    a::::::am::::m   m::::m   m::::m"
 log "r:::::r           e::::::::e         h:::::h     h:::::o:::::ooooo:::::b:::::bbbbbb::::::o:::::ooooo:::::a::::a    a::::::am::::m   m::::m   m::::m"
 log "r:::::r            e::::::::eeeeeeee h:::::h     h:::::o:::::::::::::::b::::::::::::::::bo:::::::::::::::a:::::aaaa:::::::am::::m   m::::m   m::::m"
 log "r:::::r             ee:::::::::::::e h:::::h     h:::::hoo:::::::::::oob:::::::::::::::b  oo:::::::::::oo a::::::::::aa::::m::::m   m::::m   m::::m"
 log "rrrrrrr               eeeeeeeeeeeeee hhhhhhh     hhhhhhh  ooooooooooo  bbbbbbbbbbbbbbbb     ooooooooooo    aaaaaaaaaa  aaaammmmmm   mmmmmm   mmmmmm"
