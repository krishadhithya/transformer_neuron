...
class MultiHeadAttention(tf.keras.Model):
    ...
    def __init__(self, model_size, h):
        ...
        self.h = h
        self.wq = tf.keras.layers.Dense(model_size) # [tf.keras.layers.Dense(self.query_size) for _ in range(h)]
        self.wk = tf.keras.layers.Dense(model_size) # [tf.keras.layers.Dense(self.key_size) for _ in range(h)]
        self.wv = tf.keras.layers.Dense(model_size) # [tf.keras.layers.Dense(self.value_size) for _ in range(h)]
